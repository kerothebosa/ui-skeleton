...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"@skeleton-ui/net","description":"Framework-agnostic skeleton loader enhancer driven by fetch/xhr network interceptors.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"src":"/logo.svg","alt":"@skeleton-ui/net"},"nav":[{"text":"Architecture","link":"/architecture"},{"text":"Lifecycle & Events","link":"/lifecycle-and-events"},{"text":"API","link":"/api-reference"},{"text":"Interceptors","link":"/interceptors"},{"text":"Testing","link":"/testing"},{"text":"Playground","link":"/playground"},{"text":"Examples","link":"/examples"},{"text":"Demo","link":"/demo/"}],"sidebar":[{"text":"Get Started","items":[{"text":"Overview","link":"/"},{"text":"Examples","link":"/examples"}]},{"text":"Core Docs","items":[{"text":"Architecture","link":"/architecture"},{"text":"Lifecycle & Events","link":"/lifecycle-and-events"},{"text":"API Reference","link":"/api-reference"},{"text":"Interceptors","link":"/interceptors"},{"text":"Testing","link":"/testing"},{"text":"Playground","link":"/playground"},{"text":"Real-World Testing","link":"/real-world-testing"},{"text":"Contributing","link":"/contributing"}]}],"search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/skeleton-ui/net"}],"editLink":{"pattern":"https://github.com/skeleton-ui/net/edit/main/:path","text":"Edit this page on GitHub"},"footer":{"message":"Released under the MIT License.","copyright":"Copyright (c) skeleton-ui"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BMgcpWG0.js"));
